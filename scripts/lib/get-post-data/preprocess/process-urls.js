...
function toLocalhost(text, url, port) {
    var localhost = 'http://local.marinatravelblog.com:' + port;
...
exports.changeToLocalhost = function (data) {
    data.target.link = 'http://local.marinatravelblog.com:4000/' + data.target.meta.slug+'/';
    return data;
};
...
describe("process-urls :", function () {
    ...
    var expectedText = util.format("qweqweqw %s http://local.marinatravelblog.com:12/asd.com %s see http://local.marinatravelblog.com:12/dd link.com!", newline, newline);
    var basic = {
        settings: {
            server: {
                prod: {
    ...
    var expectedData = {
        ...
        common: {
            list: [
                {markdown: expectedText, meta:{link:"http://local.marinatravelblog.com:12/q"}},
                {markdown: "no urls", meta:{link:""}}
            ]
        }
    };
    ...
    it('should change urls to local.marinatravelblog.com', function () {
